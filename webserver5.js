                ...
                exec(command, async (error, stdout, stderr) => {
                    ...
                    try {
                        ...
                        for (const obj of jsonObjects) {
                            ...
                            if (existe) {
                                console.warn(`⚠️ Registro #${obj["n_registro"]} ya existe, no se inserta.`);
                                duplicados++;
                                continue;
                            }
                        ...
                        console.log(`📦 Resumen archivo ${filename}:`);
                        console.log(`✔️ ${insertados} nuevos registros insertados.`);
                        console.log(`⚠️ ${duplicados} duplicados omitidos.`);
                        console.log(`🚫 ${omitidos} registros sin identificador omitidos.`);
